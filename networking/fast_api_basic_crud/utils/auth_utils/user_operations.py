...
def add_user_to_auth_db(file_path: str, user: User):
    """
...
def is_username_duplicate(file_path, username):
    user_db = load_json(file_path)
...
def retrieve_user_from_auth_db(file_path: str, user_request: User) -> dict:
    """
