from backend_utils.file_operations import load_json, write_json
from backend_utils.userAuth_utils.password_utils import hash_password
...
def retrieve_user_from_auth_db(user_request: User):
    ...
    db_user_path = "database/db_userAuth.json"
    try:
...
def update_tokens_in_db(username: str, token: str):
    ...
    :return:
    """
    db_user_path = "database/db_user_tokens.json"
    try:
